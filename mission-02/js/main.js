...
function inputEmailHandler(e) {
  ...
  if (isValid) {
    statusIcon.setAttribute("src", "./images/check-icon.svg");
    errorMsg.innerText = "";
    validationFlag[0] = true;
  } else {
    statusIcon.setAttribute("src", "./images/warning-icon.svg");
...
function eyeIconClickHandler(e) {
  ...
  if (type === "password") {
    e.target.setAttribute("src", "./images/close-eye-icon.svg");
    pwdInput.setAttribute("type", "text");
  } else {
    e.target.setAttribute("src", "./images/eye-icon.svg");
...
function submitHandler(e) {
  ...
  e.preventDefault();
  loginButtonImage.setAttribute("src", "./images/loading-spinner.svg");
